...
# Ex: logical.html.txt:IF(test: Number; [thenvalue: Number]; [otherwisevalue: Number])
# Then/Otherwise can really be just about anything.
...
def create_typed_signature(syntax: str, param_info: dict) -> str:
    ...
    for param in params:
        ...
        try:
            ...
            logger.error(f"{func_name} Missing required parameter key: {e}")
            return None
